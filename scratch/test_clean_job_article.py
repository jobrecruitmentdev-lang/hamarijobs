...
with open(r"c:\hk\hamarijobs\scratch\run_3backlinks_test.php", "w", encoding="utf-8") as f:
    f.write(test_runner_php)

res = subprocess.run(["php", r"c:\hk\hamarijobs\scratch\run_3backlinks_test.php"], capture_output=True, text=True, cwd=r"c:\hk\hamarijobs")
print(res.stdout)
if res.stderr:
