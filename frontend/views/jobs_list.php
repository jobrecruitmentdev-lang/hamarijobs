...
<div class="container" style="padding: 3rem 0 5rem;">
  ...
  <div class="filter-panel">
    <form method="GET" action="/government-jobs" class="filter-grid">
      <!-- Search Input -->
      <div>
        <input 
          type="text" 
      ...
      <div style="display: flex; gap: 0.5rem;">
        <button type="submit" class="btn btn-primary" style="padding: 0.65rem 1.25rem;">Apply Filters</button>
        <?php if (!empty($search) || !empty($qualification) || !empty($state) || !empty($category)): ?>
